...
def create_auto_game() -> Game:
    ...
    """
    return Game(3, 0, 0, [500, 1000])


def create_smart_game() -> Game:
    """Run a game with one smart player, one random".
    """
    return Game(3, 1, 1, [5000])
...
def create_one_random_one_human_game() -> Game:
    return Game(3, 0, 2, [])
