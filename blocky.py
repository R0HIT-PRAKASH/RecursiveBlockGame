...
class MainState(GameState):
    ...
    def update(self) -> GameState:
        """Checks the state of the game and returns either the end of the game
        or the current game
        """
...
class AnimateMoveState(GameState):
    ...
    def update(self) -> GameState:
        """Determine what GameState to be in
        """
    ...
    def render(self, renderer: Renderer) -> None:
        """Shows the selected block and move animation
        """
...
class GameOverState(GameState):
    ...
    def render(self, renderer: Renderer) -> None:
        """Draws the end of the game screen
        """
        x = 10
        y = 10
